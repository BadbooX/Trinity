...
import {
  IconAddBusinessOutlineRounded,
  IconBookmarkFlagOutlineRounded,
  IconLocationCityRounded,
  IconMarkunreadMailboxOutlineRounded,
  IconPaymentsOutlineRounded,
  IconSignpostOutlineRounded,
...
const createShop = async () => {
  ...
  if (parseInt(shop.value.address.postalCode).toString() === 'NaN') {
    error.value = 'Postal code must be a number'
    return
  }
  try {
    await shopStore.addShop(shop.value)
  } catch (e) {
