...
export const productBarCodeSchema = {
  type : 'object',
  properties: {
...
const createProductData = {
  ...
  properties: {
    ...
    priceHT: { type: 'number' },
    priceTVA: { type: 'number' },
    priceTTC: { type: 'number' },
  },
  required: ['barCode', 'name', 'stock', 'priceHT', 'priceTVA', 'priceTTC'],
} as const;
  ...
  fastify.get('/product/:barCode', {
    schema: {
     ...
     async (
      ...
      reply
  ) => getProductByBarCode(request, reply, fastify));
